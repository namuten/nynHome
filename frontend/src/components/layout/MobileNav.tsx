...
export default function MobileNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-[-34px] left-0 right-0 z-40 bg-slate-950/90 border-t border-slate-900 shadow-[0_-8px_30px_rgba(0,0,0,0.3)] backdrop-blur-xl px-2 pb-[calc(34px+0.5rem)] font-body touch-none select-none">
