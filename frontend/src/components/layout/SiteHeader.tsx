...
export default function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full glass-surface border-b border-surface-container transition-all duration-300 max-md:touch-none max-md:select-none">
