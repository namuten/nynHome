...
export default function SiteHeader() {
  ...
  return (
    <header className="fixed md:sticky top-0 left-0 right-0 z-40 w-full glass-surface border-b border-surface-container pt-[env(safe-area-inset-top)] transition-all duration-300 max-md:touch-none max-md:select-none">
